...
ActiveRecord::Schema.define(version: 2019_09_05_040341) do
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.index ["operation_type_id"], name: "index_transactions_on_operation_type_id"
  end

  add_foreign_key "transactions", "accounts"
  add_foreign_key "transactions", "operation_types"
end
